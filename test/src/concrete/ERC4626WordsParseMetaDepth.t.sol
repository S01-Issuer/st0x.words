...
import {PARSE_META_BUILD_DEPTH as GENERATED_DEPTH} from "../../../src/generated/ERC4626WordsPointers.sol";
...
contract ERC4626WordsParseMetaDepthTest is Test {
    function testParseMetaBuildDepthConstantsAgree() external pure {
        assertEq(
            ...
            "PARSE_META_BUILD_DEPTH in ERC4626SubParser.sol and ERC4626WordsPointers.sol must agree"
        );
    }
}
